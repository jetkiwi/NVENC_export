...
#define RENDERMOD_VERSION	prAcceleratedRendererVersion500

typedef struct
{
	prPluginID outIdentifier;
	unsigned int outPriority; //0 is the priority of the host renderer - a plugin generally wants to be higher
