...
**	user has attached one format such as CEA-608 from a SCC file to a Timeline, both CEA-608 and 
**	CEA-708 callbacks will function as Premiere converts from CEA-608 to CEA-708 data on the fly.
**	If the user has attached a MCC (CEA-708) file, Premiere will first attempt to extract the CEA-608
...
**
**	GetCaptionInfo()
**		Provides metadata about the caption file that was imported.
**
...
typedef struct  
{
	...
	*/
	...
	/*
	**	Used to retrieve the metadata associated with a MCC or SCC file that was imported for the sequence.
	**	Mostly used for debugging purposes to know the source of the data.
	**
	**	@param	inTimelineID			the timeline instance ID used for all captioning suite communication,
	**									it is passed into the player instance in the pmNewListParms struct.
	**	@param	outFileFormat			The file format as specified from within the MCC or SCC file.
	**	@param	outCaptionUUID			The UUID assigned to the MCC file.
	**	@param	outCreationProgram		The tool that created the MCC file.
	**	@param	outCreationDate			The date of when the MCC file was created.
	**	@param	outCreationTime			The time of when the MCC file was created.
	*/
