...
#define IMPORTMOD_VERSION		IMPORTMOD_VERSION_12
...
typedef struct
{
	...
	csSDK_int32				reserved[17];		// reserved; set to null;
} imImportInfoRec;
...
{
	void*			privatedata;			// instance data from imGetInfo
	PrPixelFormat	outPixelFormat;			// fourCC of pixel format [TODO] need definitions of pixel formats
} imIndPixelFormatRec;
